...
@section('page_title', 'Tambah Pesan Baru')
            ...
            <form action="{{ route('admin.contacts.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="unread" {{ old('status') === 'unread' ? 'selected' : '' }}>Belum Dibaca</option>
                        <option value="read" {{ old('status') === 'read' ? 'selected' : '' }}>Sudah Dibaca</option>
                    </select>
                    @error('status')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
