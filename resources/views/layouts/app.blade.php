...
<head>
    ...
    <title>@yield('title', 'Yudi Interior - Solusi Interior Modern')</title>
    ...
    <a href="{{ route('home') }}" class="flex items-center group">
        ...
        <span class="text-2xl font-bold tracking-tight">
            ...
            <span class="text-orange-500">Interior</span>
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <a href="#services" class="nav-link px-4 py-2 text-gray-700 hover:text-orange-500 font-medium transition-colors duration-200 rounded-lg hover:bg-orange-50">Layanan</a>
                    <a href="#portofolio" class="nav-link px-4 py-2 text-gray-700 hover:text-orange-500 font-medium transition-colors duration-200 rounded-lg hover:bg-orange-50">Portofolio</a>
                    <a href="#testimonials" class="nav-link px-4 py-2 text-gray-700 hover:text-orange-500 font-medium transition-colors duration-200 rounded-lg hover:bg-orange-50">Testimoni</a>
                    <a href="#contact" class="nav-link px-4 py-2 text-gray-700 hover:text-orange-500 font-medium transition-colors duration-200 rounded-lg hover:bg-orange-50">Kontak</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden border-t border-gray-200 mobile-menu-open">
            <div class="px-4 pt-2 pb-4 space-y-1 bg-white">
                <a href="#home" class="block px-4 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-600 rounded-lg font-medium transition">Beranda</a>
                <a href="#services" class="block px-4 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-600 rounded-lg font-medium transition">Layanan</a>
                <a href="#portofolio" class="block px-4 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-600 rounded-lg font-medium transition">Portofolio</a>
                <a href="#testimonials" class="block px-4 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-600 rounded-lg font-medium transition">Testimoni</a>
                <a href="#contact" class="block px-4 py-3 text-gray-700 hover:bg-orange-50 hover:text-orange-600 rounded-lg font-medium transition">Kontak</a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
                ...
                <div>
                    ...
                    <p class="text-gray-400 mb-6 leading-relaxed">
                        Kami menciptakan ruang yang indah dan fungsional untuk mewujudkan rumah impian Anda dengan sentuhan profesional.
                    </p>
                ...
                <div>
                    ...
                    <p class="text-gray-400 mb-4 leading-relaxed">Dapatkan tips & inspirasi desain interior terbaru langsung ke email Anda</p>
            ...
            <div class="border-t border-gray-800 mt-12 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
                    <p>&copy; {{ date('Y') }} Yudi Interior. All Rights Reserved.</p>
