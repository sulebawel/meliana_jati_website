...
@section('title', 'Meliana jati - Solusi furniture Modern')
...
<section id="home" class="relative min-h-screen flex items-center overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center fade-in-up z-20">
        ...
        <p class="text-xl md:text-2xl mb-8 text-gray-200">
            Desain furniture modern dan elegan untuk menciptakan ruang yang sempurna sesuai kepribadian Anda
        </p>
...
<section id="services" class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600">Solusi lengkap untuk kebutuhan rumah Anda</p>
        </div>
...
<section id="contact" class="py-20 bg-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600">Mari wujudkan impian Anda bersama kami</p>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">Jl. Sunardi sinanggul 04/01 <br>MLONGGO,JEPARA 59453</p>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">+62 89531749792</p>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">melianajati@gmail.com</p>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">Senin - Minggu: 08.00 - 17.00<br>Jum'at: Tutup</p>
                    </div>
                </div>
            </div>
